    ...
    methods: {
      openButtonModal() {
        ...
        switch(button) {
          ...
          this.$emit('mobile-screen-state', 'newChat')
          this.$emit('screen-state', 'newChat')
      }
    }
}
</script>
